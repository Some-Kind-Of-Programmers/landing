        ...
        <div className="flex flex-col lg:flex-row items-center justify-between">
          <div className="lg:w-1/2 lg:pr-12 mb-10 lg:mb-0">
            ...
            <div className="flex flex-wrap gap-4">
              <Button asChild size="lg" className="bg-skop-orange hover:bg-skop-orange/90 text-white">
            ...
            <div className="bg-white/10 backdrop-blur-sm p-6 rounded-2xl shadow-xl relative z-10">
              <div className="font-mono bg-gray-900/70 p-4 rounded-lg overflow-hidden">
                ...
                <div className="text-sm">
                  <div className="mb-2"><span className="text-green-400">user@skop</span>:<span className="text-skop-blue/90">~</span>$ connect telegram</div>
                  <div className="mb-2 text-blue-200">Connecting to Some Kind Of Programmers...</div>
                  <div className="mb-2 text-blue-200">Great! You're connected to the community!</div>
                  <div className="mb-2"><span className="text-green-400">user@skop</span>:<span className="text-skop-blue/90">~</span>$ explore community</div>
                  <div className="mb-2 text-blue-200">Discovering active members and discussions...</div>
                  <div className="mb-2 text-blue-200">Found: Code sharing, project collaborations, tech discussions</div>
