          ...
          <div className="bg-gray-50 rounded-xl p-6 shadow-inner">
            <div className="bg-white rounded-lg shadow-sm p-6 border border-gray-100">
              <div className="mb-4 flex items-center">
                <div className="w-10 h-10 rounded-full bg-blue-500 flex items-center justify-center text-white font-semibold mr-3">TG</div>
                <div>
              ...
              <div className="mt-5 flex items-center">
                ...
                />
                <button className="ml-2 p-2 bg-primary-600 text-white rounded-lg flex items-center justify-center">
