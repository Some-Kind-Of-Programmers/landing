...
const faqItems = [
  ...
  },
  {
    ...
    answer:
      "Очень активное! Люди постоянно задают вопросы, общаются, что-то публикуют и посещают мероприятия. Мы регулярно проводим мок-интервью, коворкинги, сессии клуба английского языка и вечеринки.",
    value: "item-2",
  },
  {
  ...
  },
  {
    ...
    answer:
      "Вообще нет. У нас есть представители всех подмножеств IT-сферы: программисты, аналитики, менеджеры, инвесторы, стартаперы. представители HR-сферы. Члены сообщества - те, кто программирует свои жизни. Если так можно выразиться, конечно.",
    value: "item-6",
  },
];
