...
const aboutItems = [
  {
    ...
    description:
      "Обменивайся идеями, делись best practices и получай информацию от лучших специалистов различных областей.",
  },
  {
    icon: <FaUsers />,
  ...
  },
  {
    ...
    description:
      "Создавай и развивай проекты, находи партнёров и инвесторов, находи работу и сотрудников абсолютно бесплатно.",
  },
];
